...
%if 0%{?fedora} >= 39 || 0%{?rhel} >= 6 || %{amzn} >= 2023
%{!?build_agent2: %global build_agent2 1}
%endif
%if 0%{?fedora} >= 39 || 0%{?rhel} >= 8 || %{amzn} >= 2023
%{!?build_web_service: %global build_web_service 1}
%endif
%endif

%if 0%{?fedora} >= 39 || 0%{?rhel} >= 7 || %{amzn} >= 2023
...
%if 0%{?fedora} >= 39 || 0%{?rhel} >= 9 || %{amzn} >= 2023
...
Group:			Applications/Internet
%if 0%{?fedora} >= 39 || 0%{?rhel} == 7 || 0%{?rhel} == 8
...
%if 0%{?build_java_gateway}
%patch 2 -p1
%if 0%{?fedora} >= 39 || 0%{?amzn} >= 2023 || 0%{?rhel} >= 9
%patch 9 -p1
%endif
%endif
